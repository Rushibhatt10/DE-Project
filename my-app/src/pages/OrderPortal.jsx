    ...
    return (
        <div className="min-h-screen bg-background text-foreground font-sans relative">
            ...
            <div className="fixed inset-0 z-0 pointer-events-none">
                <div className="absolute top-0 right-0 w-1/3 h-1/3 bg-cyan-500/5 rounded-full blur-[120px]" />
                <div className="absolute bottom-0 left-0 w-1/3 h-1/3 bg-cyan-500/5 rounded-full blur-[120px]" />
            </div>
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <GlassCard className="p-8">
                            ...
                            <div className="relative px-4">
                                ...
                                {/* Active Progress Bar */}
                                <div
                                    className="absolute left-0 top-1/2 -translate-y-1/2 h-1 bg-gradient-to-r from-cyan-600 to-cyan-400 rounded-full -z-10 transition-all duration-700 ease-out shadow-[0_0_15px_rgba(34,211,238,0.5)]"
                          ...
                          ${isActive ? "bg-background border-cyan-500 scale-110 shadow-[0_0_15px_rgba(34,211,238,0.4)]" : "bg-card border-border scale-100"}
                          ${isCompleted ? "bg-cyan-500 border-cyan-500 text-black" : ""}
                        `}>
                                                    {isCompleted ? <CheckCircle2 className="w-5 h-5" /> :
                                                        isActive ? <div className="w-3 h-3 bg-cyan-500 rounded-full animate-pulse shadow-[0_0_10px_rgba(34,211,238,0.8)]" /> :
                                ...
                                <div className="space-y-3">
                                    ...
                                    {order.status === "Accepted" && (
                                        <MagneticButton
                                            ...
                                            className="w-full py-3 bg-cyan-600 text-black font-bold rounded-xl shadow-[0_0_20px_rgba(34,211,238,0.2)] hover:bg-cyan-500 hover:shadow-[0_0_30px_rgba(34,211,238,0.4)] transition-all"
                                        >
                                            Start Travel
                                        </MagneticButton>
                                    )}
